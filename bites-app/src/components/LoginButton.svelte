<script lang="ts">
	import { authLoading, authStore, loginWithGoogle, loginWithFacebook, logout } from '$lib/stores/authStore';
...
<main>
	...
	<dialog class="modal" class:modal-open="{login_modal_open}">
		<div class="modal-box join join-vertical">
			...
			<button class="btn btn-lg bg-[color:#1778f2] text-[color:white]" on:click={facebookLoginHandler}>
